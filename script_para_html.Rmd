...
É possível fazer o knit apenas apertand o botão do Rmd. 

## Divulgação de IA:

usei o prompt: 
tenho um dataframe no R. quero criar gráficos a partir dele usando o ggplot2. uma das colunas se chama "codigo_UF" (1-5, regiões), outra que se chama "nome_UF, a coluna de valores se chama "tx_desocup", e a de anos, "ano". quero um gráfico que faz a série histórica da taxa para essas regiões.
